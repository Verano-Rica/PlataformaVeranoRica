...
const FasesProceso = () => {
  ...
  const renderFase = () => {
    switch (faseActual) {
      case 1:
        return <Fase1Documentos datos={datos} actualizar={actualizarDatos} actualizarEstado={fetchEstadoYDatos} idUsuario={idUsuario} />;
      case 2:
        return <Fase2Talla datos={datos} actualizar={actualizarDatos} actualizarEstado={fetchEstadoYDatos} idUsuario={idUsuario} />;
      case 3:
        return <Fase3Disponibilidad datos={datos} actualizar={actualizarDatos} actualizarEstado={fetchEstadoYDatos} idUsuario={idUsuario} />;
      case 4:
        return <Fase4Gracias />;
      default:
